...
describe("Empty state function", () => {
  beforeAll(async () => {
    ...
    setupTestFrame(
      /* html */ `
      <button x-ref="btn1" data-cspine="reset:string" @click="$_.state.reset"></button>
      <button x-ref="btn2" data-cspine="reset:array" @click="$_.state.reset"></button>
      <button x-ref="btn3" data-cspine="reset:object" @click="$_.state.reset"></button>
  `,
      data
    );
  });
