...
describe("Type state function", () => {
  beforeAll(async () => {
    ...
    setupTestFrame(
      /* html */ `
      <span id="el1" data-type="string" data-var="string" x-show="$_.state.type"></span>
      <span id="el2" data-type="array" data-var="array" x-show="$_.state.type"></span>
      <span id="el3" data-type="object" data-var="object" x-show="$_.state.type"></span>
      <span id="el4" data-type="function" data-var="fn" x-show="$_.state.type"></span>
      <span id="el5" data-type="number" data-var="number" x-show="$_.state.type"></span>
      <span id="el6" data-type="undefined" data-var="un" x-show="$_.state.type"></span>
  `,
      data
    );
  });
