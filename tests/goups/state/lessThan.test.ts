...
describe("lessThan state function", () => {
  beforeAll(async () => {
    ...
    setupTestFrame(
      /* html */ `
      <span id="el1" data-value="2" data-cast="value=number" data-var="number" x-show="$_.state.lessThan"></span>
      <span id="el2" data-value="0" data-cast="value=number" data-var="number" x-show="$_.state.lessThan"></span>
  `,
      data
    );
  });
