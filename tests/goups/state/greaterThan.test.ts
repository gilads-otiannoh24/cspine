...
describe("greaterThan state function", () => {
  beforeAll(async () => {
    ...
    setupTestFrame(
      /* html */ `
      <span id="el1" data-value="2" data-cast="value=number" data-var="number" x-show="$_.state.greaterThan"></span>
      <span id="el2" data-value="6" data-cast="value=number" data-var="number" x-show="$_.state.greaterThan"></span>
  `,
      data
    );
  });
